...
from .routers.astock import create_astock_router
from .routers.conversation import create_conversation_router
from .routers.crypto_pool import create_crypto_pool_router
...
def _add_routes(app: FastAPI, settings) -> None:
    ...
    # Include A-share data router
    app.include_router(create_astock_router(), prefix=API_PREFIX)

    # Include dynamic crypto pool router
    app.include_router(create_crypto_pool_router(), prefix=API_PREFIX)
